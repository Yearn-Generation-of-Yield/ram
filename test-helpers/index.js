...
const NFT1 = await that.nftFactory.deployNFT("RAM level 1", "RAMLEVEL1NFT", "https://run.mocky.io/v3/3da52de1-1e4f-4e7e-8ae7-b68be4278835", setterAccount, true, false, MAX_INT, {
  from: setterAccount,
});
that.nftAddrs.push(NFT1.receipt.rawLogs[0].address);

const NFT2 = await that.nftFactory.deployNFT("RAM level 2", "RAMLEVEL2NFT", "https://run.mocky.io/v3/3da52de1-1e4f-4e7e-8ae7-b68be4278835", setterAccount, true, false, MAX_INT, {
  from: setterAccount,
});
that.nftAddrs.push(NFT2.receipt.rawLogs[0].address);
const NFT3 = await that.nftFactory.deployNFT("RAM level 3", "RAMLEVEL3NFT", "https://run.mocky.io/v3/3da52de1-1e4f-4e7e-8ae7-b68be4278835", setterAccount, true, false, MAX_INT, {
  from: setterAccount,
});
that.nftAddrs.push(NFT3.receipt.rawLogs[0].address);
const NFT4 = await that.nftFactory.deployNFT("RAM level 4", "RAMLEVEL4NFT", "https://run.mocky.io/v3/3da52de1-1e4f-4e7e-8ae7-b68be4278835", setterAccount, true, false, MAX_INT, {
  from: setterAccount,
});
that.nftAddrs.push(NFT4.receipt.rawLogs[0].address);
const NFT5 = await that.nftFactory.deployNFT("RAM level 5", "RAMLEVEL5NFT", "https://run.mocky.io/v3/3da52de1-1e4f-4e7e-8ae7-b68be4278835", setterAccount, true, false, MAX_INT, {
  from: setterAccount,
});
that.nftAddrs.push(NFT5.receipt.rawLogs[0].address);

// Deploy a dummy dXIOT token to use as Robot NFT
const NFTROBOT = await that.nftFactory.deployNFT("RAM Robot NFT", "RAMROBOTNFT", "https://run.mocky.io/v3/3da52de1-1e4f-4e7e-8ae7-b68be4278835", setterAccount, false, true, 50, {
  from: setterAccount,
});
that.nftAddrs.push(NFTROBOT.receipt.rawLogs[0].address);

// Deploy a dummy dXIOT token to use as Robot NFT
const NFTLINK = await that.nftFactory.deployNFT("RAM LINK NFT", "RAMLINKNFT", "https://run.mocky.io/v3/3da52de1-1e4f-4e7e-8ae7-b68be4278835", setterAccount, false, false, MAX_INT, {
  from: setterAccount,
});
