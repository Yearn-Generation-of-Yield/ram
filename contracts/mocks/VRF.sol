...
contract VRF {
    ...
    uint256
        private constant GROUP_ORDER = // solium-disable-next-line indentation // Number of points in Secp256k1
    0xFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFEBAAEDCE6AF48A03BBFD25E8CD0364141;
    // Prime characteristic of the galois field over which Secp256k1 is defined
    uint256
        private constant FIELD_SIZE = // solium-disable-next-line indentation
