...
const deployRAMToken = async (mnemonic = "", mainnet = false) => {

    // Get the built metadata for our contracts
    let tokenUnpacked = unpackArtifact("./artifacts/RAM.json")
...
const deployRamVault = (ramTokenAddress = "0x62359ed7505efc61ff1d56fef82158ccaffa23d7") => {
    let ramVaultUnpacked = unpackArtifact("./artifacts/FeeApprover.json")
}
