...
async function main() {
  ...
  for (let i = 0; i < 20; i++) {
    ...
    let tx = await RAM.transfer(deployer, ethers.utils.parseEther("25"));
    await tx.wait();
  }

  const RAMVault = await ethers.getContractAt("RAMVault", "0x30Fc2B26c118E9CFFAEEf579620EF08c55Dbda85");
